...
label sofiathirddate:
    ...
    "Huuum... Olha só, vai estrear no cinema, nesse final de semana, a adaptação pra filme do {i}Four Nights at Frank's{/i}... A Sofia disse que gostou dos livros que fizeram sobre o jogo, talvez ela goste do filme também."
    ...
    p "Eu te entendo... Com jogos é até pior. A maioria dos filmes não chega a passar nem a mesma ideia geral do que o jogo é. Esses dias eu vi o {i}trailer{/i} do filme do {i}Zonik{/i} que vai sair e quase infartei de tanta tristeza."
    ...
    "Nosso romance começou. A primavera da juventude floresceu para mim durante minha faculdade. Pena que nem tudo que começa bem, acaba bem." 
    
    "Mas isso, é uma história para o futuro..."
