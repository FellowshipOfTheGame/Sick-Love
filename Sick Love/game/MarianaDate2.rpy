...
"Ok, só mais uma tentativa, vamos fazer a saideira."
...
"Finalmente consegui terminar o jogo, a Mariana não {i}tava{/i} de de brincadeira quando falou que o jogo era difícil."
...
p "Antes que pergunte, eu estou ótimo, consegui terminar Sekido, mesmo desacredito."

m "Caramba, parabéns. Eu não acreditva que você conseguiria ganhar hoje mesmo, mas isso foi por que eu achava que você pretendia ir na primeira aula pela manhã."
...
p "Bom saber que eu não estou no sal sozinho."
...
p "Ata, quero ver então. Até amanhã, eu acho."
...
m "Hum... não sei. Que tal começarmos pelos classicos?"
...
m "Aqui também outros jogos mais comuns, quer tentar ir no jogo de arremesso à cesta?"
...
p "Quer jogar outra coisa? Podemos jogar {i}Street Kombat{/i}, mas ja deixo avisado que eu não vou pegar leve."

show mariana standing

m "Opa, desculpa ai, vamos ver se você joga do mesmo tanto que você fala."
...
p "A tela branca do Akomo de novo não!"
...
p "Eu sei, mas eu nunca tinha me encontrado pessoalmente com um jogador profissional. Me da um autógrafo?"
...
"Se eu não tinha me feito de idiota antes agora eu consegui fazer isso com toda a classe e mastria de um bobo da corte."
...
m "Wow, calma ai bandeirante, vai com calma hahaha, mas bem, já vou indo, tchau tchau."
