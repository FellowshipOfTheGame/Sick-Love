...
b "Bem, então é só entrar na fila, por que todo mundo aqui já esta com o ticket na mão pro trem do {i}hype{/i}. *risos*"

m "Eu não estou só com esse ticket na mão, pra falar a verdade eu até já comprei o ingresso pra estréia."
...
"*Bate a mão nos bolsos*"

p "Galera... vão sem mim..."

b "Pô cara, deixa de drama, bora logo."

p "Eu esqueci minha carteira no dormitório..."
...
m "Olha só que menino atento você é."
...
m "Pra falar a verdade acho que nem eles acreditam direito ainda, já que passaram o ultimo ano só vagabundeando."

m "Assim, não é como se eu só estivesse estudando, mas eles estão de parabéns."

p "Sério? O que você curte fazer?"
...
p "Sim! Você já viu aquele sobre o cara que acha um caderno onde só precisa escrever o nome de alguém lá enquanto pensa na pessoa e ela morre?"

m "{i}Die Note{/i}? Nossa, é um dos meus favoritos! Queria ter tanto estilo pra comer uma batatinha."
...
m "Somos dois. Esse é o meu contato."
