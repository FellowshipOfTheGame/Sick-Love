...
b "Acho que pode ser uma boa ideia. Que tal esse sábado? Podemos ir naquele {i}pub{/i} que abriu mês passado."

d "Por mim {i}já é{/i}. [povname], você está livre?"
...
p "Só nos três, {i}ué{/i}. Vamos só conversar, ouvir o que estiver tocando e talvez beber um pouco."
...
d "Por quê? Se formos no pub podemos matar dois coelhos numa cajadada só. Já faz um tempo que não saímos só nós três."

b "Né, e eu acho melhor ser no pub pra não acabar virando um rolê muito baixo astral"
...
g "Você realmente precisa ir? O Diego conhece o Bruno há muito mais tempo, será que não seria melhor irem só os dois?"
...
p "Façamos assim, eu vou com eles pro {i}pub{/i}. Se não sairmos muito tarde eu passo no teu apê. Se terminar tarde eu te mando mensagem e tentamos fazer algo domingo à tarde."
...
p "Bem, minha proposta está feita ali em cima, se mudar de ideia me avise. Mas esse sábado eu já estou ocupado."
